...
$handler_ordner1textBox_TextChanged= 
{
...
$handler_FehlermeldungText_Click= 
{
#TODO: Place custom script here
...
$handler_startSynkButton_Click= 
{
    if($global:File1Path -ne "" -and $global:File2Path -ne "")
    {
        ...
        $global:pidprocess = start-job -FilePath 'C:\Users\Ali Elchab\Desktop\SYNK\SyncFolders.ps1' -argumentlist $global:File1Path,$global:File2Path
...
{#Correct the initial state of the form to prevent the .Net maximized form issue
	$SynkWindow.WindowState = $InitialFormWindowSdtate
}



#Design des Fenster und allen einzelnen Elemente, kann man hier abändern
...
$startSynkButton.add_Click($handler_startSynkButton_Click)
